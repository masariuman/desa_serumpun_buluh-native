			...
			<div id="singlepage">
				<div class="main section" id="main"><div class="widget Blog" data-version="1" id="Blog1">
					...
					<div class="blog-posts hfeed">
						...
						<span class="text-title">ACARA</span></h2></div>
										...
										<div class="post-body entry-content" id="post-body-7717256934861432929" itemprop="description articleBody">
											...
											<div style="margin-left: 1em; margin-right: 1em; text-align: right;">
												...
												@foreach($acara as $acara_list)
												<div>
													<h2 class="title"><span>{{$acara_list->judul_event}}</span></h2>
												</div>
												<div>
						<div class="item-snippet">{{$acara_list->isi_event}}</div>
						<div><b>Pada Tanggal {{$acara_list->tanggal_event}}</b></div>
