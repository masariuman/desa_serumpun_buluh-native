			...
			<div class="post-container">
				<div id="singlepage">
					...
					<div class="recent-post-title"><h2>
						<span class="text-title">Menampilkan Berita Dari Kategori {{$kategori_id->nama_kategori}}</span></h2></div>
													...
													<span class="author-info">
														...
														<span class="vcard">
															<span class="fn" itemprop="author" itemscope="itemscope" itemtype="http://schema.org/Person">
																<meta target="_blank" content="{{url('artikel/Kategori/'.$kategori_id->nama_kategori)}}" itemprop="url">
																<a class="g-profile" target="_blank" href="{{url('artikel/Kategori/'.$kategori_id->nama_kategori)}}" rel="author" title="author profile" data-gapiscan="true" data-onload="true" data-gapiattached="true">
																	<span itemprop="name">
