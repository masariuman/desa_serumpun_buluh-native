				...
				<div class="main section" id="main"><div class="widget Blog" data-version="1" id="Blog1">
					...
					<div class="blog-posts hfeed">
						...
						<div class="date-outer">
							...
							Kondisi Geografis Desa Serumpun Buluh
										</h1>
										...
										<div class="post-body entry-content" id="post-body-7717256934861432929" itemprop="description articleBody">
											...
											<div style="margin-left: 1em; margin-right: 1em; text-align: right;"><a href="{{url('fotoupload/'.$desa->peta)}}" target="_blank" title="Peta Desa">
												<img class="CSS_LIGHTBOX_SCALED_IMAGE_IMG" src="{{ asset('fotoupload/'.$desa->peta)}}" style="font-family: &#39;&#39;; text-align: center;"></a></div>
												
												
													{!! html_entity_decode($desa->geografis) !!}
													@endforeach	
