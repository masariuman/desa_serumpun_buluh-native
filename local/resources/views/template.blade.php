...
<!-- confirmation delete artikel-->
  ...
  function deleteKomentar(komentarId) {
    ...
    headers: {
      ...
      $.ajax({
        url: "komentar/delete/" + komentarId,
        type: "post"
      })
      .done(function(data) {
        swal("Deleted!", "Your file was successfully deleted!", "success");
  ...
  <!-- confirmation delete komentar2-->
        <script>
  $('button.delete-komentar2').click(function() {
    var komentar2Id = $(this).attr("data-photo-id");
    deleteKomentar2(komentar2Id);
  });

  function deleteKomentar2(komentar2Id) {
    swal({
      title: "Apakah anda yakin?", 
      text: "Apakah anda yakin ingin menghapus?", 
      type: "warning",
    ...
    headers: {
      ...
      $.ajax({
        url: "admin/artikel/komentar/delete/" + komentar2Id,
        type: "post"
      })
      .done(function(data) {
        swal("Deleted!", "Your file was successfully deleted!", "success");
...
<script>
  ...
  function deletePhoto(suaraId) {
    ...
    headers: {
      ...
      $.ajax({
        url: "suara_warga/delete/" + suaraId,
        type: "post"
      })
      .done(function(data) {
        swal("Deleted!", "Your file was successfully deleted!", "success");
  ...
  <!-- confirmation delete suara_warga 2-->
<script>
  $('button.delete-suara2').click(function() {
    var suara2Id = $(this).attr("data-photo-id");
    deletePhoto2(suara2Id);
  });

  function deletePhoto2(suara2Id) {
    swal({
      title: "Apakah anda yakin?", 
      text: "Apakah anda yakin ingin menghapus?", 
      type: "warning",
    ...
    headers: {
      ...
      $.ajax({
        url: "admin/suara_warga/delete/" + suara2Id,
        type: "post"
      })
      .done(function(data) {
        swal("Deleted!", "Your file was successfully deleted!", "success");
