          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ubah Pemerintahan Umum Desa</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div>
                  {!! Form::model($kategori, ['method' => 'PATCH', 'action' => ['DesaController@update_pemerintahan', $kategori->id]]) !!}
                      {!! csrf_field() !!}
                      @if(isset($kategori))
  {!! Form::hidden('id',$kategori->id) !!}
@endif
<!-- isi -->
{!! Form::label('pemerintahan', 'Isi Pemerintahan Umum :', ['class' => 'control-label']) !!}
{!! Form::textarea('pemerintahan', null, ['class' => 'form-control']) !!}
@if($errors->has('pemerintahan'))
  <span><i><b><font color="red">{{$errors->first('pemerintahan')}}</font></b></i></span><br>
@endif
...
<div class="form-group">
  {!! Form::submit('Ubah Pemerintahan Umum Desa', ['class' => 'btn btn-primary form-control']) !!}
</div>
                  {!! Form::close() !!}
