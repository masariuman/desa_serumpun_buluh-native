            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div>
                  {!! Form::model($kategori, ['method' => 'PATCH', 'action' => ['DesaController@update_dusun', $kategori->id], 'files' => true]) !!}
                     {!! csrf_field() !!}
@if(isset($kategori))
...
<br>
{!! Form::submit('Ubah Data Dusun', ['class' => 'btn btn-primary form-control']) !!}
                  {!! Form::close() !!}
