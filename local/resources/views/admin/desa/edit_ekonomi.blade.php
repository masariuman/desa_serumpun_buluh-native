            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div>
                  {!! Form::model($kategori, ['method' => 'PATCH', 'action' => ['DesaController@update_ekonomi', $kategori->id]]) !!}
                      {!! csrf_field() !!}
                      @if(isset($kategori))
  {!! Form::hidden('id',$kategori->id) !!}
@endif
<!-- isi -->
{!! Form::label('ekonomi', 'Isi Keadaan Ekonomi Desa :', ['class' => 'control-label']) !!}
{!! Form::textarea('ekonomi', null, ['class' => 'form-control']) !!}
@if($errors->has('ekonomi'))
  <span><i><b><font color="red">{{$errors->first('ekonomi')}}</font></b></i></span><br>
@endif
...
<div class="form-group">
  {!! Form::submit('Ubah Keadaan Ekonomi Desa', ['class' => 'btn btn-primary form-control']) !!}
</div>
                  {!! Form::close() !!}
