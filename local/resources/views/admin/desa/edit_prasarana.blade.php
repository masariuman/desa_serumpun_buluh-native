          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Ubah Prasarana dan Sarana Desa</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div>
                  {!! Form::model($kategori, ['method' => 'PATCH', 'action' => ['DesaController@update_prasarana', $kategori->id]]) !!}
                      {!! csrf_field() !!}
                      @if(isset($kategori))
  {!! Form::hidden('id',$kategori->id) !!}
@endif
<!-- isi -->
{!! Form::label('prasarana', 'Isi Prasarana dan Sarana Desa :', ['class' => 'control-label']) !!}
{!! Form::textarea('prasarana', null, ['class' => 'form-control']) !!}
@if($errors->has('prasarana'))
  <span><i><b><font color="red">{{$errors->first('prasarana')}}</font></b></i></span><br>
@endif
...
<div class="form-group">
  {!! Form::submit('Ubah Prasarana dan Sarana Desa', ['class' => 'btn btn-primary form-control']) !!}
</div>
                  {!! Form::close() !!}
