            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div>
                  {!! Form::model($kategori, ['method' => 'PATCH', 'action' => ['DesaController@update_visi_misi', $kategori->id]]) !!}
                      {!! csrf_field() !!}
                      @if(isset($kategori))
  {!! Form::hidden('id',$kategori->id) !!}
@endif
<!-- isi -->
{!! Form::label('visi_misi', 'Isi Visi & Misi :', ['class' => 'control-label']) !!}
{!! Form::textarea('visi_misi', null, ['class' => 'form-control']) !!}
@if($errors->has('visi_misi'))
  <span><i><b><font color="red">{{$errors->first('visi_misi')}}</font></b></i></span><br>
@endif
...
<div class="form-group">
  {!! Form::submit('Ubah Visi & Misi', ['class' => 'btn btn-primary form-control']) !!}
</div>
                  {!! Form::close() !!}
